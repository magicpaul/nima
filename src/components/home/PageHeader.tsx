export default function PageHeader({ title, description }) {
  return (
    <div className="flex flex-col lg:justify-between lg:flex-row container py-8 mx-auto ">
      <h2 className="max-w-lg font-sans text-3xl font-bold tracking-tight text-gray-900 dark:text-gray-50 sm:text-4xl sm:leading-none group">
      ...
      <p className="text-gray-700 dark:text-gray-200 lg:text-md lg:max-w-md prose">
        {description}
      </p>
    </div>
  );
