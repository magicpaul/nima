...
const FeatureSection: React.FC<Props> = ({ description1, description2 }) => {
  return (
    <main className="flex-1 w-full container px-4 py-8 mx-auto md:px-8 md:py-16">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
        <div>
          <p className="text-gray-400 dark:text-gray-100 text-lg">
            {' '}
        ...
        <div className="text-gray-400 dark:text-gray-100 col-span-2">
