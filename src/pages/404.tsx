...
const NotFoundPage: NextPage<Props> = ({ homeContent }) => {
  ...
  return (
    <div className="h-screen flex flex-col justify-between">
      ...
      <div className="mx-auto  flex items-center justify-center">
        <div className="container flex flex-col items-center justify-center my-8 px-5 mx-auto space-y-8 text-center sm:max-w-lg">
          <Image
            src="/img/404.svg"
